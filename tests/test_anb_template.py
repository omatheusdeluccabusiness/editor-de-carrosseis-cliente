...
class AnbTemplateTest(unittest.TestCase):
    ...
    def test_template_has_direct_editing_and_local_autosave(self):
        ...
        self.assertIn('id="blockGap"', anb)
        self.assertIn('coverTextBoxes(s,H', anb)
        self.assertIn("brandLogo.src='/assets/brand/anb-logo.png'", anb)
        self.assertIn('showLogo:i===0||i===9', anb)
        self.assertNotIn('id="directBrand"', anb)
